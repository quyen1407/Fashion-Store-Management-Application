...
class Menu_w(QMainWindow):
    def __init__(self):
        ...
        self.btnsanpham.clicked.connect(self.go_to_sanpham)
        self.btnnhaphanphoi.clicked.connect(self.go_so_NhaPhanphoi)
    ...
    def go_to_sanpham(self):
        widget.setCurrentWidget(San_Pham)
        widget.resize(800,555)
    def go_so_NhaPhanphoi(self):
        widget.setCurrentWidget(Nha_Phan_Phoi)  
        widget.resize(800,555)  
...
class SanPham(QMainWindow):
    def __init__(self):
        ...
        self.btntrangchu.clicked.connect(self.go_to_menu)
        self.btnnhaphanphoi.clicked.connect(self.go_so_NhaPhanphoi)
        # Thiết lập font chữ
        font = QFont()
        font1 = QFont()
        ...
        self.label.setFont(font1)
        self.masp.setFont(font)
        self.tensp.setFont(font)
        self.soluong.setFont(font)
        self.loaisp.setFont(font)
        self.trangthai.setFont(font)
        self.mnpp.setFont(font)
        self.sotien.setFont(font)
        self.btnthem.setFont(font2)
        self.btncapnhat.setFont(font2)
        self.btnxoa.setFont(font2)
        self.btnclear.setFont(font2)
        self.btntimkiem.setFont(font)
    def go_to_menu(self):
        # chuyển về form menu chinh
        widget.setCurrentWidget(Menu_form)
        widget.resize(780,510)
    def go_so_NhaPhanphoi(self):
        widget.setCurrentWidget(Nha_Phan_Phoi)  
...
# XỬ LÝ NHÀ PHÂN PHỐI
class Nhaphanphoi(QMainWindow):
    def __init__(self):
        super(Nhaphanphoi, self).__init__()
        uic.loadUi("nhaphanphoi.ui", self)
        font = QFont()
        font1 = QFont()
        font.setFamily("Arial")
        font.setPointSize(9)
        ...
        self.btnnhanvien.setFont(font)
        self.btntrangchu.setFont(font)
        self.manpp.setFont(font)
        self.tennpp.setFont(font)
        self.sdtnpp.setFont(font)
        self.emailnpp.setFont(font)
        self.dcnpp.setFont(font)
        self.btntimkiem.setFont(font)
...
# XỬ LÝ KHÁCH HÀNG
class khachhang(QMainWindow):
    def __init__(self):
        super(khachhang, self).__init__()
        uic.loadUi("khachhang.ui", self)
        font = QFont()
        font1 = QFont()
...
Nha_Phan_Phoi = Nhaphanphoi()
# Thêm các cửa sổ vào QStackedWidget
...
widget.addWidget(Nha_Phan_Phoi)
# Đặt cửa sổ mặc định khi chạy
widget.setCurrentWidget(Nha_Phan_Phoi)  

# Cố định kích thước cửa sổ
# widget.resize(460,400)
widget.resize(800,555) # thường ra chiều rộng trước và chiều dài sau
# Hiển thị giao diện
widget.show()
